...
**Subject / Module:** ______________________________  
**Teacher / Lecturer:** ______________________________  
...
The project does **not** claim that this dataset is the complete raw municipal operational fault-log database.
...
Do **not** rename `app.py` to `streamlit.py`, because that would conflict with the installed Streamlit library.
...
Complete these after uploading and deploying:

- **GitHub repository:** `https://github.com/YOUR-USERNAME/AquaSafe-Durban`
- **Streamlit application:** `https://YOUR-APP.streamlit.app`

---

### Academic note

All reported metrics and forecasts in this repository are generated from the included AquaSafe dataset and modelling workflow. The project clearly separates documented historical events, engineered historical-risk scores and exploratory machine-learning forecasts.
